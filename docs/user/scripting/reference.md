...
Canonical: https://paneflow.dev/docs/scripting/reference
...
This is the compact reference for [Scripting and automation](/docs/scripting).
...
## Agent state fields [#agent-state-fields]
...
## JSON-RPC connection [#json-rpc-connection]
